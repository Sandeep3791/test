"""
Django settings for supplier project.
...
SECRET_KEY = 'django-insecure-xrfi)bn7o4#z5(rk=)_c1b8big_4=!6khm!(j*q^!ct$ce1yki'
...
WSGI_APPLICATION = 'supplier.wsgi.application'
...
# MEDIA_ROOT = 'wayrem-admin-backend/media'
