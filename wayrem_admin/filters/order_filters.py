...
from wayrem_admin.models.StaticModels import BusinessType,Customer
...
class OrderFilter(django_filters.FilterSet):
    ...
    business_type=django_filters.Filter(method='customer_business_type_filter', label="Business type")
    class Meta:
        model = Orders
