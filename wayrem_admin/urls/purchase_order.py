...
urlpatterns = [
    ...
    path('', views.POList.as_view(), name='polist'),
    path('ajax/load_supplier_products', views.load_supplier_products,
         name='load_supplier_products'),
    # path('po-list/', views.POList1.as_view(), name='polist1'),
    ...
    path('confirm-delivery/<str:id>', views.confirm_delivery, name='confirm_delivery'),
