...
from wayrem_admin.models_orders import OrderDetails,OrderLoginextShipment
...
class CustomerLib(ApiBase):
    ...
    def get_customer_id(self,customer_id):
        get_customer=OrderLoginextShipment.objects.filter(customer=customer_id).first()
    ...
    def create_customer(self,order_details,account_code):
        ...
        response=ApiBase.send_request(self,method,path,create_customer,headers,"json")
        return response
    ...
    def update_customer(self,order_details,reference_id):
        ...
        get_authenticate=self.get_authenticate_key()
        headers={'WWW-Authenticate':get_authenticate}
        response=ApiBase.send_request(self,method,path,update_customer,headers,"json")
        return response
