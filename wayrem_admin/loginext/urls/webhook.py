...
urlpatterns = [
    ...
    #path('order/partiallydeliveredorder',webhook_order_views.LogiNextWeebHookOrderAPI.as_view({'get': 'partiallydeliveredorder'}),name='partiallydeliveredorder'),
    ...
    #path('order/pickeduporder',webhook_order_views.LogiNextWeebHookOrderAPI.as_view({'get': 'pickeduporder'}),name='pickeduporder'),
    #path('order/orderattemptedpickuporder',webhook_order_views.LogiNextWeebHookOrderAPI.as_view({'get': 'orderattemptedpickuporder'}),name='orderattemptedpickuporder'),
