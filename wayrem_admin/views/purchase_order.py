    ...
    if request.method == "POST":
        if request.session['products'] == []:
            ...
            for product, quantity in zip(products, quantities):
                ...
                product_order = PurchaseOrder(
                    po_id=po_id, po_name=po_name, product_name=product_instance, unit_price=supplier_product_instance.price, supplier_product=supplier_product_instance, product_qty=product_qty, supplier_name=supplier_name)
                product_order.save()
